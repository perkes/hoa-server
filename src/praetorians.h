...
#ifndef PRAETORIANSCOOPNPC_H
#define PRAETORIANSCOOPNPC_H
#include <vector>
#include <memory>
#include <string>
#include "vb6compat.h"
...
extern std::vector<int> PretorianAIOffset;
extern std::vector<int> PretorianDatNumbers;
/* ' */
/* ''Added by Nacho */
